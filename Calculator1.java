...
class Calculator1
{
    ...
    {
        MarevellousCalculator mobj = new MarevellousCalculator(400,400,"Marvellous");
...
class MarevellousCalculator extends WindowAdapter implements ActionListener
{
    ...
    public MarevellousCalculator(int width, int height, String title)
    {
        ...
        b2.setBounds(180,280,80,40);   //X Y W H
        b3.setBounds(260,280,80,40);   //X Y W H
        b4.setBounds(320,280,80,40);   //X Y W H
    ...
    public void windowClosing(WindowEvent obj)   //Event handler for frames
    {
        System.exit(0);
    }
